from our_networks_ocr.IndividualCharacterClassifier import IndividualCharacterClassifier
...
model = IndividualCharacterClassifier(num_classes=36) # train with 10^-4 90 epchs then 10^-5 another 10 epchs
...
train_losses, test_losses = torch_utils_allinone.train_loop_individual_chars(
                                                    model, 
